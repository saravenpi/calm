...
│   ├── config.rs                  # Configuration management (~/.calm.yml)
│   ├── url_cleaner.rs             # URL parsing and protocol handling
│   ├── tabs/                      # Tab management
│   │   ├── mod.rs                 # Public API
│   │   ├── manager.rs             # TabManager with webview lifecycle
│   │   └── tab.rs                 # Individual tab structure
│   ├── privacy/                   # Privacy protection layer
│   │   ├── mod.rs                 # Privacy configuration
│   │   └── scripts/               # JavaScript injection scripts
│   │       ├── mod.rs             # Script builder
│   │       ├── core.rs            # Core privacy script
│   │       ├── fingerprint.rs     # Fingerprinting protection
│   │       ├── tracking.rs        # Tracking blocker
│   │       └── title_tracker.rs   # Page title updates
│   └── ui/                        # User interface components
│       ├── mod.rs                 # UI module exports
│       ├── template.rs            # Main HTML template
│       ├── overlay.rs             # URL input overlay
│       ├── tab_bar/               # Tab bar component
│       │   ├── mod.rs
│       │   ├── html.rs            # Tab bar HTML structure
│       │   ├── styles.rs          # Tab bar CSS
│       │   └── script.rs          # Tab bar JavaScript
│       ├── download_overlay/      # Download sidebar
│       │   ├── mod.rs
│       │   ├── html.rs            # Download sidebar HTML
│       │   ├── styles.rs          # Download sidebar CSS
│       │   └── script.rs          # Download sidebar JavaScript
│       ├── animations/            # UI animations
│       │   ├── mod.rs
│       │   ├── loader.rs          # Loading animations
│       │   ├── transitions.rs     # Transition effects
│       │   └── interactions.rs    # Interactive animations
│       └── renderers/             # Content renderers
│           ├── mod.rs
│           └── content.rs         # Main content renderer
├── Cargo.toml                     # Dependencies and metadata
├── install.sh                     # macOS installation script
├── .calm.yml.example              # Example configuration file
├── README.md                      # This file
├── PRIVACY.md                     # Detailed privacy documentation
